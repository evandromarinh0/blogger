  ...
  return(
    <section className="container bg-gray-700 grid gap-6 md:grid-cols-2 pt-8 pb-8 md:pt-20 md:pb-32">
      <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
        ...
        <h2 className={`${ptSansCaption.className} text-gray-100 text-heading-sm md:text-heading-lg`}>Crie um catálogo de produtos online em poucos minutos</h2>
      </div>

      <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
        <span className="text-body-tag text-blue-200 bg-blue-400 px-2 py-1 w-fit rounded-sm uppercase">Prático</span>
        <h2 className={`${ptSansCaption.className} text-gray-100 text-heading-sm md:text-heading-lg`}>Venda para seu público através de uma plataforma única</h2>
      </div>
      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            <h2 className={`${ptSansCaption.className} text-gray-100 text-heading-sm md:text-heading-lg`}>Tenha uma loja online personalizada com a cara da sua marca</h2>
