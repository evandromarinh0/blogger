    ...
    <Link href={`/blog/${props.slug}`} className="w-full max-w-2xl rounded-3xl border-[1px] border-gray-400 bg-gray-600 overflow-hidden transition-all duration-300 hover:border-[1px] hover:border-blue-300">
      <div className="p-2 rounded-md overflow-hidden">
        ...
        <div className="px-2 mt-4 space-y-4 ">
          <h2 className="text-heading-sm text-gray-100 line-clamp-3 min-h-12">{props.title}</h2>
          <p className="text-gray-300 text-body-sm line-clamp-3">{props.description}</p>

          <div className="flex items-center gap-3 border-t border-gray-400 py-4">
            <div className="relative h-6 w-6 md:h-8 md:w-8 overflow-hidden rounded-full border-blue-200 border-[1px]">
